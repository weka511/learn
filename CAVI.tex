...
\begin{table}[H]
	\begin{center}
		...
		\begin{tabular}{|l|p{12cm}|}\hline
			...
			$C$&Any additive constant arising during the calculation of $\ELBO$. It can always be discarded, since we are interested in the values of parameters that maximize $\ELBO$, not the value of $\ELBO$. \\ \hline
