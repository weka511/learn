...
Following \cite{wiki:kullback:leibler} we define the Kullback-Leibler divergence, and derive Theorem \ref{thm:kl:ge}, which will be used in the sequel.
...
\end{align*}
We will use the Kullback-Leibler divergence to derive a bound for the evidence.
\begin{align*}
