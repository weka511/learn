...
\newglossaryentry{gls:KL}{
	...
	description={The Kullback-Leibler Divergence between two proabability distributions $\KLD{q(z)}{p(z)}$ measures the information lost by representing $p(x)$ by $q(x)$--\eqref{eq:kl}}
}
